...
- За один проход делать только одно преобразование над ортогональной дугой — только над одним сегментом или точкой, включая порождение нового сегмента
- Если есть две коллинеарных сегмента с общей точкой и надо один сдвинуть, то можно использовать эту общую точку и вставить ортогональный отрезок с использованием этой точки
- Удаление коллинеарной точки — в самом последнем порядке (после всех других преобразований)
